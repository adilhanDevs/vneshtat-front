  ...
  return (
    <div className="order-drawer-backdrop" onClick={onClose}>
      <div className="order-drawer" style={{ width: 600, padding: 30, borderRadius: "36px 0 0 36px" }} onClick={(e) => e.stopPropagation()}>
        ...
        {view === "reports" && (
          <>
            ...
            <div className="order-drawer-body" style={{ padding: 0, flex: 1, overflowY: "auto" }}>
              <p className="order-sec-p" style={{ marginBottom: 16 }}>
            ...
            <div className="order-drawer-foot">
              <button className="order-btn-ghost" onClick={onClose}>Отмена</button>
              <button className="order-btn-primary" onClick={onClose}>Скачать все отчёты</button>
            </div>
          </>
        )}
        ...
        {view === "report" && (
          <>
            <div className="order-drawer-head" style={{ marginBottom: 12, display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "none", padding: 0 }}>
            ...
            <div className="order-drawer-body" style={{ padding: 0, flex: 1, overflowY: "auto" }}>
              ...
              <div className="order-sec-h" style={{ marginTop: 0 }}>Аванс и суточные</div>
              <p className="order-sec-p" style={{ marginBottom: 16, color: "#787880", fontSize: 14, lineHeight: 1.2 }}>Укажите сумму аванса и суточных, которые сотрудник получил в кассе организации.</p>
              <div className="exp-card">
                <div className="e-left">
                  <div className="e-name">Суточные</div>
                  <div className="order-sec-p" style={{ margin: "2px 0 0", fontSize: 14, color: "#8c909c", fontWeight: 500 }}>Москва, 06.04.2025 – 08.04.2025</div>
                </div>
              ...
              <button className="order-modal-outline" onClick={() => setView("advance")}>Добавить</button>
              <div className="order-sec-h">Расходы</div>
              <p className="order-sec-p" style={{ marginBottom: 16, color: "#787880", fontSize: 14, lineHeight: 1.2 }}>Укажите все расходы в поездке, на которые был потрачен выданный аванс. Указывать расходы по суточным не нужно.</p>
              <div className="exp-card">
                <div className="e-left">
              ...
              <button className="order-modal-outline" onClick={() => setView("expense")}>Добавить</button>
              <div className="order-sec-h">Документы</div>
              <p className="order-sec-p" style={{ marginBottom: 16, color: "#787880", fontSize: 14, lineHeight: 1.2 }}>Вы можете приложить подтверждающие расходы документы (например, квитанция, чек, накладная)</p>
            ...
            <div className="order-drawer-foot" style={{ padding: "24px 0 0", borderTop: "none", display: "flex", gap: 14 }}>
              <button className="order-btn-ghost" style={{ width: 140, flex: "0 0 140px", height: 52, borderRadius: 18, fontSize: 15, fontWeight: 500, background: "#eceef2", color: "#787880", border: "none", cursor: "pointer" }} onClick={() => setView("reports")}>Отмена</button>
              <button className="order-btn-primary" style={{ flex: 1, height: 52, borderRadius: 18, fontSize: 15, fontWeight: 500, background: "#007bfb", color: "#fff", border: "none", cursor: "pointer" }} onClick={() => setView("reports")}>Сохранить</button>
            </div>
          </>
        )}
        ...
        {view === "advance" && (
          <>
            ...
            <div className="order-drawer-body" style={{ padding: 0, flex: 1, overflowY: "auto" }}>
              <p className="order-sec-p" style={{ marginBottom: 18 }}>
              ...
              <div className="order-grid2">
                <div className="order-field"><label>Дата с</label><div className="val">11 марта, чт</div><span className="cal"><IcCalSmall /></span></div>
                <div className="order-field"><label>Дата по</label><div className="val">11 марта, чт</div><span className="cal"><IcCalSmall /></span></div>
              </div>
            ...
            <div className="order-drawer-foot" style={{ padding: "24px 0 0", borderTop: "none", display: "flex", gap: 14 }}>
              <button className="order-btn-ghost" style={{ width: 140, flex: "0 0 140px", height: 52, borderRadius: 18, fontSize: 15, fontWeight: 500, background: "#eceef2", color: "#787880", border: "none", cursor: "pointer" }} onClick={() => setView("report")}>Удалить</button>
              <button className="order-btn-primary" style={{ flex: 1, height: 52, borderRadius: 18, fontSize: 15, fontWeight: 500, background: "#007bfb", color: "#fff", border: "none", cursor: "pointer" }} onClick={() => setView("report")}>Сохранить</button>
            </div>
          </>
        )}
        ...
        {view === "expense" && (
          <>
            ...
            <div className="order-drawer-body" style={{ padding: 0, flex: 1, overflowY: "auto" }}>
              ...
              <div className="order-field" style={{ marginBottom: 12 }}><label>ФИО</label><div className="val">Вознесенский Иван Сергеевич</div><span className="cal"><IcLockField /></span></div>
              <div className="order-field" style={{ marginBottom: 12 }}><label>Название расхода</label><div className="val">Обед в ресторане Twins Garden</div></div>
              <div className="order-field" style={{ marginBottom: 12 }}><label>Подтверждающий документ</label><div className="val">Кассовый чек</div><span className="chev"><IcChevron /></span></div>
              <div className="order-grid2">
                <div className="order-field"><label>Номер</label><div className="val">30623098</div></div>
                <div className="order-field"><label>Дата</label><div className="val">11 марта</div><span className="cal"><IcCalSmall /></span></div>
              </div>
